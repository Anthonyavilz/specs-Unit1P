...
############################# TO DO ####################################
    ...
    master_ouput = "COPY ({0}) TO STDOUT WITH CSV HEADER".format(master_query)
...
############## CREATING CSV FILES FROM OUTPUTS #########################
    ...
    with open('product_revenue.csv', 'w') as file:
        ...
        print("Product Revenue successful")
